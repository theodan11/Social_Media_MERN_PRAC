...
import { createPost, getAllPost, getSinglePost, updatePost, likePost, deletePost, userPosts, userTimeline, getUserPhotos } from '../controller/postController.js'
...
router.get('/user/photos/:id', getUserPhotos)
